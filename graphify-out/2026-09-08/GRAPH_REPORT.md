# Graph Report - minimacore-desktop  (2026-09-08)

## Corpus Check
- 112 files · ~291,414 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2327 nodes · 5325 edges · 125 communities (107 shown, 18 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 496 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `65141da9`
...
### Community 0 - "app.js"
Cohesion: 0.03
Nodes (93): RFC-1918, absCmp(), applyMailUpdate(), applyTheme(), axStatusCache, BAL_BY_TID, CASINO_PIP, CASINO_PRESETS (+85 more)
...
Cohesion: 0.13
Nodes (30): applyIcon(), balBreakdown(), balCardHtml(), casinoAgeGate(), cmd(), copy(), decSub(), enhanceTokenIcons() (+22 more)

### Community 14 - "el"
Cohesion: 0.07
Nodes (57): appendLog(), appendTerm(), boot(), contribHelp(), currentWwMode(), drawQR(), el(), ewConfirmSend() (+49 more)
...
Cohesion: 0.08
Nodes (56): claim(), coinAmount(), deleteTxn(), grain(), isDecimal(), isHex(), isHexOrMinima(), loadKeys() (+48 more)

### Community 22 - "esc"
Cohesion: 0.11
Nodes (28): axCoinDump(), axEditInput(), axEditRow(), axFld(), axGenField(), axGenRow(), axLevelRow(), axMakerEditor() (+20 more)
...
### Community 25 - "k"
Cohesion: 0.20
Nodes (11): "node_modules/elliptic/lib/elliptic/curve/base.js"(), "node_modules/elliptic/lib/elliptic/curve/edwards.js"(), "node_modules/elliptic/lib/elliptic/curve/short.js"(), "node_modules/elliptic/lib/elliptic/ec/index.js"(), "node_modules/elliptic/lib/elliptic/ec/key.js"(), feeGrowth(), k(), splitReconciles() (+3 more)
...
Cohesion: 0.08
Nodes (45): applyPpDir(), axExportKey(), axWelcome(), confirmPpWithdraw(), doPpCollect(), doPpStatement(), doPpSwap(), mailBubbleHtml() (+37 more)
...
### Community 47 - "d"
Cohesion: 0.26
Nodes (17): "node_modules/hash.js/lib/hash/sha/256.js"(), block(), build(), cell(), cells(), classify(), d(), fixed() (+9 more)

### Community 48 - "node-manager.js"
Cohesion: 0.13
Nodes (18): alive(), { app }, commandOf(), config, EventEmitter, fs, killPid(), listeners() (+10 more)
...
### Community 54 - "build"
Cohesion: 0.11
Nodes (18): build, appId, extraResources, linux, nsis, productName, win, artifactName (+10 more)
...
Cohesion: 0.14
Nodes (13): electron, electron-builder, author, description, devDependencies, electron, electron-builder, license (+5 more)
...
Cohesion: 0.15
Nodes (13): scripts, dist, dist:linux, dist:mac, dist:mac:signed, dist:win, fetch:parlons, gate:atomix (+5 more)
...
### Community 123 - "pinMinimaSend"
Cohesion: 0.27
Nodes (11): pinMinimaSend(), advanceStatus(), init(), looksLikeMinimaAddress(), placeOrder(), randomId(), reply(), retryPayment() (+3 more)

### Community 124 - "withTimeout"
Cohesion: 0.46
Nodes (8): jvm(), makerAvail(), makerPublish(), makerSave(), makerWithdraw(), switchCurrency(), toVm(), withTimeout()

## Knowledge Gaps
- **361 isolated node(s):** `{ EventEmitter }`, `crypto`, `{ rpcCall }`, `{ createContext }`, `{ pinMinimaSend }` (+356 more)
...
- **Why does `p()` connect `p` to `poolmgr.js`, `casino.js`, `peg.js`, `pandapools/service.js`, `"node_modules/bn.js/lib/bn.js"`, `renderCasino`, `atomix.js`, `d`, `withTimeout`, `s`, `node-manager.js`, `vestr.js`, `init`, `ethTokensLoad`, `k`, `"node_modules/tweetnacl/nacl-fast.js"`, `ethSendReview`, `showConfirm`?**
  _High betweenness centrality (0.176) - this node is a cross-community bridge._
- **Why does `s()` connect `s` to `pandapools.js`, `otc.js`, `renderAxSwap`, `"node_modules/bn.js/lib/bn.js"`, `settle.js`, `init`, `k`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `k()` connect `k` to `poolmgr.js`, `ui.js`, `NodeManager`, `"node_modules/tweetnacl/nacl-fast.js"`, `pandapools/service.js`, `history.js`, `curve.js`, `renderSettings`, `vestr.js`, `d`, `store.js`, `config.js`?**
...
- **What connects `{ EventEmitter }`, `crypto`, `{ rpcCall }` to the rest of the system?**
  _361 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `app.js` be split into smaller, more focused modules?**
  _Cohesion score 0.03442982456140351 - nodes in this community are weakly interconnected._
