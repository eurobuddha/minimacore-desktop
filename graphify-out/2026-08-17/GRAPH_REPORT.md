# Graph Report - minimacore-desktop  (2026-08-16)

## Corpus Check
- 101 files · ~262,411 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2231 nodes · 5143 edges · 114 communities (102 shown, 12 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 511 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `26383193`
...
Cohesion: 0.10
Nodes (22): acceptMid(), { app }, config, createAnchor(), { createContext, ALL_FILES }, effLevel(), emitter, EventEmitter (+14 more)
...
Cohesion: 0.29
Nodes (8): clone(), convertBase(), getBase10Exponent(), intPow(), isDecimalInstance(), parseDecimal(), parseOther(), truncate()
...
### Community 106 - "atomix/service.js"
Cohesion: 0.56
...
## Knowledge Gaps
- **342 isolated node(s):** `install.sh script`, `{ EventEmitter }`, `path`, `fs`, `{ rpcCall }` (+337 more)
...
- **Why does `s()` connect `s` to `app.js`, `otc.js`, `k`, `el`, `boot`, `t`, `settle.js`, `init`, `pandapools.js`, `"node_modules/bn.js/lib/bn.js"`?**
