...
## Corpus Check
- 139 files · ~314,088 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2556 nodes · 5748 edges · 133 communities (116 shown, 17 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 528 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a8822e6a`
...
- `harness()` --indirect_call--> `t()`  [INFERRED]
  scripts/pandapools-recovery.test.cjs → preflight-portmap.mjs
...
Cohesion: 0.20
Nodes (10): http, rpcCall(), timeoutFor(), WRITE_PREFIXES, runner(), assert, net, { rpcCall } (+2 more)

### Community 109 - "pandapools-parity-check.cjs"
Cohesion: 0.15
Nodes (12): assert, ctx, feed, files, fs, html, htmlCode, path (+4 more)

### Community 110 - "atomix/service.js"
Cohesion: 0.56
...
## Knowledge Gaps
- **446 isolated node(s):** `name`, `productName`, `version`, `description`, `author` (+441 more)
...
- **Why does `p()` connect `p` to `poolmgr.js`, `casino.js`, `actionOnPool`, `pandapools/service.js`, `renderCasino`, `atomix.js`, `renderPandapools`, `pandapools.js`, `peg.js`, `d`, `k`, `s`, `init`, `ethSendReview`, `ethTokensLoad`, `activity-chain.js`, `vestr.js`, `"node_modules/bn.js/lib/bn.js"`, `rpcCall`, `withTimeout`?**
  _High betweenness centrality (0.184) - this node is a cross-community bridge._
- **Why does `k()` connect `k` to `ui.js`, `NodeManager`, `pandapools/service.js`, `activity-chain.js`, `curve.js`, `renderSettings`, `atomix/service.js`, `d`, `store.js`, `config.js`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `s()` connect `s` to `pandapools.js`, `otc.js`, `esc`, `"node_modules/bn.js/lib/bn.js"`, `p`, `k`, `settle.js`, `init`, `createAnchor`?**
