...
## Corpus Check
- 119 files · ~300,191 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2424 nodes · 5522 edges · 128 communities (111 shown, 17 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 515 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `292d987e`
...
Cohesion: 0.07
Nodes (69): address(), send(), addAnnounceState(), advanceKeyUses(), beginHunt(), buildAndPost(), buildCreate(), buildMigrate() (+61 more)
...
Cohesion: 0.07
Nodes (58): derivePools(), done(), finishScan(), fund(), gatherOwned(), gatherRegistry(), group(), parseScripts() (+50 more)
...
Cohesion: 0.12
Nodes (21): actRecord(), actRecordFailed(), actSetStatus(), create(), ensureHistory(), ensureOwnPools(), esc(), histInsert() (+13 more)
...
Cohesion: 0.07
Nodes (62): checkFailure(), claim(), coinAmount(), confirmationDepth(), deleteTxn(), flag(), grain(), guardedCoins() (+54 more)
...
Cohesion: 0.13
Nodes (15): scripts, dist, dist:linux, dist:mac, dist:mac:signed, dist:win, fetch:parlons, gate:atomix (+7 more)
...
## Knowledge Gaps
- **396 isolated node(s):** `{ app }`, `{ spawn, execFileSync }`, `EventEmitter`, `fs`, `path` (+391 more)
...
- **Why does `k()` connect `k` to `ui.js`, `NodeManager`, `pandapools/service.js`, `activity-chain.js`, `curve.js`, `copy`, `d`, `store.js`, `atomix/service.js`, `config.js`?**
...
- **What connects `{ app }`, `{ spawn, execFileSync }`, `EventEmitter` to the rest of the system?**
