# Graph Report - minimacore-desktop  (2026-08-24)

## Corpus Check
- 104 files · ~278,831 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2279 nodes · 5144 edges · 122 communities (110 shown, 12 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 458 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `529d879a`
...
- **Why does `p()` connect `p` to `vestr.js`, `k`, `poolmgr.js`, `casino.js`, `peg.js`, `pandapools/service.js`, `rpc.js`, `"node_modules/bn.js/lib/bn.js"`, `casinoActivity`, `atomix.js`, `d`, `withTimeout`, `s`, `init`, `ethTokensLoad`, `"node_modules/tweetnacl/nacl-fast.js"`, `ethSendReview`, `showConfirm`?**
  _High betweenness centrality (0.196) - this node is a cross-community bridge._
- **Why does `s()` connect `s` to `k`, `pandapools.js`, `AtomiX OTC Deals`, `renderAxSwap`, `"node_modules/bn.js/lib/bn.js"`, `quoteAndStash`, `settle.js`, `createAnchor`, `init`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `ppPairRows()` connect `showConfirm` to `app.js`, `toast`, `esc`, `p`?**
