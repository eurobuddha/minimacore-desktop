...
## Corpus Check
- 104 files · ~277,364 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2269 nodes · 5193 edges · 120 communities (107 shown, 13 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 505 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bcff0fa8`
...
### Community 5 - "otc.js"
Cohesion: 0.11
Nodes (49): accept(), addMsg(), allDeals(), apply(), applyPropose(), approxEq(), changed(), claimExecute() (+41 more)
...
### Community 38 - "s"
Cohesion: 0.13
Nodes (16): initDb(), "node_modules/elliptic/lib/elliptic/ec/signature.js"(), "node_modules/hash.js/lib/hash/ripemd.js"(), "node_modules/hash.js/lib/hash/sha/1.js"(), "node_modules/js-sha3/src/sha3.js"(), balance(), aggregateInfo(), createPreview() (+8 more)
...
- **Why does `k()` connect `k` to `store.js`, `pandapools/service.js`, `ui.js`, `curve.js`, `poolmgr.js`, `"node_modules/tweetnacl/nacl-fast.js"`, `renderSettings`, `history.js`, `atomix/service.js`, `config.js`, `d`?**
