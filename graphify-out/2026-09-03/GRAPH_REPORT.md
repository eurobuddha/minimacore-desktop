# Graph Report - minimacore-desktop  (2026-08-28)

## Corpus Check
- 104 files · ~279,053 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2279 nodes · 5145 edges · 118 communities (107 shown, 11 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 458 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cc03166f`
...
- `wsEval()` --indirect_call--> `reject()`  [INFERRED]
  scripts/cdp-eval.js → main/atomix/lib/otc.js
...
### Community 0 - "app.js"
Cohesion: 0.03
Nodes (87): RFC-1918, absCmp(), appendLog(), applyMailUpdate(), applyTheme(), axEditInput(), axEditRow(), axFld() (+79 more)
...
### Community 14 - "el"
Cohesion: 0.10
Nodes (41): appendTerm(), boot(), currentWwMode(), drawQR(), el(), initTabScroll(), onShopUpdate(), onVestrUpdate() (+33 more)
...
### Community 22 - "esc"
Cohesion: 0.12
Nodes (29): axCoinDump(), axLevelRow(), esc(), ewConfirmSend(), ewEthIcon(), ewExportKey(), ewReceive(), ewRpcDialog() (+21 more)
...
### Community 30 - "renderHistoryList"
Cohesion: 0.13
Nodes (23): copyHistory(), ensureHistActions(), ensureHistFilter(), exportHistory(), histCells(), histDate(), histExportRows(), histFilterActive() (+15 more)

### Community 31 - "elliptic.js"
Cohesion: 0.06
Nodes (12): "node_modules/elliptic/lib/elliptic/curve/base.js"(), "node_modules/elliptic/lib/elliptic/curve/edwards.js"(), "node_modules/elliptic/lib/elliptic/curve/short.js"(), "node_modules/elliptic/lib/elliptic/ec/index.js"(), "node_modules/elliptic/lib/elliptic/ec/key.js"(), "node_modules/hash.js/lib/hash/sha/256.js"(), "node_modules/hash.js/lib/hash/sha/512.js"(), feeGrowth() (+4 more)
...
### Community 33 - "toast"
Cohesion: 0.13
Nodes (41): addPeerContact(), axOtcPropose(), compressImage(), confirmDeleteContact(), confirmDeleteThread(), contactMenu(), doArchive(), doMailBackup() (+33 more)
...
Cohesion: 0.08
Nodes (31): acceptMid(), { app }, buildMds(), config, createAnchor(), { createContext, ALL_FILES }, currentBlock(), effLevel() (+23 more)
...
### Community 49 - "s"
Cohesion: 0.11
Nodes (19): "node_modules/elliptic/lib/elliptic/ec/signature.js"(), "node_modules/hash.js/lib/hash/ripemd.js"(), "node_modules/hash.js/lib/hash/sha/1.js"(), "node_modules/js-sha3/src/sha3.js"(), balance(), aggregateInfo(), createPreview(), D() (+11 more)
...
- **Why does `p()` connect `p` to `vestr.js`, `poolmgr.js`, `casino.js`, `peg.js`, `pandapools/service.js`, `rpc.js`, `"node_modules/bn.js/lib/bn.js"`, `casinoActivity`, `atomix.js`, `d`, `withTimeout`, `s`, `init`, `ethTokensLoad`, `"node_modules/tweetnacl/nacl-fast.js"`, `ethSendReview`, `showConfirm`, `elliptic.js`?**
  _High betweenness centrality (0.197) - this node is a cross-community bridge._
- **Why does `s()` connect `s` to `pandapools.js`, `AtomiX OTC Deals`, `renderAxSwap`, `"node_modules/bn.js/lib/bn.js"`, `settle.js`, `init`, `elliptic.js`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `d()` connect `d` to `ui.js`, `AtomiX OTC Deals`, `node-manager.js`, `renderAxSwap`, `s`, `netfetch.js`, `init`, `elliptic.js`?**
